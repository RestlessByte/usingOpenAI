...
import { env } from 'bun';
import type { fireworkModels } from './types/models/fireworks.ai/type';
...
export const usingOpenAI = async (
  ...
  if (props.provider === 'MistralAI') {
    ...
    baseURL = 'https://api.fireworks.ai/inference/v1'; // Исправленный baseURL
  }
    ...
    token = 'Ollama'; // Для обхода проверки токена
